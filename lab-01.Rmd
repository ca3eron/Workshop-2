...
visitors %>% 
  summarise(
    mean_admission_2021 = mean(n_2021, na.rm = TRUE), 
    med_admission_2021 = median(n_2021, na.rm = TRUE)
  )
```
...
**NA stands for not applicable, some of the admissions data is Not Available meaning you need to input na.rm = TRUE (rm= Remove)**
